...
<body>
	...
	<div id="wrapper">
		...
		<?php if($allItems !== 0) { foreach($allItems as $value) {
			$allIpAddress = explode(',',$value['IPAddress']);
		...
		?>
		<div class="items">
			<h4><?php echo $value['NohaName']; ?></h4>
			<img src="<?php echo $value['Image']; ?>" style="width:300px; height:150px;"/>
			<p><?php echo $value['MetaDescription']; ?></p>
			<div class="rating <?php echo $class; ?>" id="<?php echo $value['Ratings']; ?>_<?php echo $value['ID']; ?>"></div>
		</div>
		<?php } } ?>
	</div><!-- end wrapper -->
